...
$options['shell-aliases']['revision'] = 'core-execute git rev-parse HEAD';
...
$options['structure-tables']['project'] = array('cache', 'cache_*', 'history', 'sessions', 'watchdog');
